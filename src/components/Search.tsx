...
const Search = () => {
  ...
  return (
    <div className="bg-black min-h-screen overflow-hidden">
      <img
        src={searchImg}
        className="absolute z-0 w-full h-[300px] object-cover"
      ></img>
      <div
        className="bg-gradient-to-t from-black pt-[300px] font-futura
